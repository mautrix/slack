...
func (s *SlackClient) HandleSlackEvent(rawEvt any) {
	...
	case *slack.DisconnectedEvent:
		omitBridgeState := s.UserLogin.BridgeState.GetPrevUnsent().StateEvent == status.StateBadCredentials
		if evt.Intentional {
...
func (s *SlackChatResync) GetChatInfo(ctx context.Context, portal *bridgev2.Portal) (*bridgev2.ChatInfo, error) {
	if s.PreFetchedInfo != nil {
		wrappedInfo, err := s.Client.wrapChatInfo(ctx, portal, s.PreFetchedInfo, portal.MXID == "")
		if err != nil {
